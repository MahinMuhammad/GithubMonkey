        ...
        NavigationStack {
            ZStack {
                VStack(alignment: .leading) {
                    ...
                    List(viewModel.getUsersToPopulateList(), selection:$selected){user in
                        Button{
                            UIPasteboard.general.string = user.username
                            withAnimation {
                                viewModel.showCopiedToClipboardAlert = true
                            }
                        }label: {
                ...
                if viewModel.showCopiedToClipboardAlert {
                    FloatingAlertView(showingNotice: $viewModel.showCopiedToClipboardAlert, image: Image(systemName: "doc.on.clipboard"), message: "Copied to Clipboard")
                }
            }
        }
    }
